...
export default {
    ...
    methods: {
        ...
        async initData() {
            const listCatatanMahasiswa = await this.$store.getters.getListCatatanPerwalianMahasiswaArsip(
                {
                    tipe: 'mahasiswa',
                    nim: this.$route.params.id
                }
            )
            const listCatatanOrangTuaWali = await this.$store.getters.getListCatatanPerwalianMahasiswaArsip(
                {
                    tipe: 'orang-tua-wali',
                    nim: this.$route.params.id
                }
            )
            const listCatatanOrangTuaWaliDanMahasiswa = await this.$store.getters.getListCatatanPerwalianMahasiswaArsip(
                {
        ...
        pulihkanCatatan(idCatatan) {
            ...
            const dataBaru = this.listDefaultAllArsip.get(tempCatatan.tipe)
            ...
            //update list data catatant tipe tersebut ke this.listDefaultAllArsip
            this.listDefaultAllArsip.set(tempCatatan.tipe, dataBaru)
